...
«Мильчин» — четвёртый член квартета редакторских инструментов для русского
текста. Каждый закрывает свою зону, не пересекаясь:
...
механика стёрется. Поэтому скрипт-типограф закрывает финальный шаг.
