...
галлюцинируют. А правило-то однозначное. Однобуквенный предлог — ВСЕГДА
прилеплен к следующему слову неразрывным пробелом. Числовой диапазон 1941-1945 —
ВСЕГДА через короткое тире (1941–1945). Тут нечего обдумывать.
...
механика сотрётся. Поэтому скрипт-типограф закрывает финальный шаг.
